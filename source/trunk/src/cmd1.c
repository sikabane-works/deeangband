...
#ifdef JP
				do_cmd_write_diary(DIARY_BUNSHOU, 0, "落とし戸に落ちた");
#else
				do_cmd_write_diary(DIARY_BUNSHOU, 0, "You have fallen through a trap door!");
#endif
...
#endif
					get_species_num_prep_trait(NULL, t_need(1, TRAIT_ELDRITCH_HORROR), NULL, 0); // Prepare allocation table
