...
//TRC_AGGRAVATE |
#define TRC_HEAVY_MASK (TRAIT_TY_CURSE | TRAIT_DRAIN_EXP | TRAIT_ADD_H_CURSE | TRAIT_CALL_DEMON | TRC_CALL_DRAGON | TRC_TELEPORT)

#define TRC_P_FLAG_MASK  \
	(TRC_TELEPORT_SELF | TRC_CHAINSWORD | \
	 TRAIT_TY_CURSE | TRAIT_DRAIN_EXP | TRAIT_ADD_L_CURSE | TRAIT_ADD_H_CURSE | \
	 TRAIT_CALL_ANIMAL | TRAIT_CALL_DEMON | TRC_CALL_DRAGON | TRAIT_COWARDICE | \
