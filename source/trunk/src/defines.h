...
#define PROJECT_FUMBLE 0x00020000
...
#define PRJ_BALL PROJECT_STOP | PROJECT_GRID | PROJECT_ITEM | PROJECT_KILL

#define cast_storm(CASTER_PTR, EFFECT, POWER, RAD, TRAIT_ID) \
...
#define object_is_fixed_artifact(T) ((T)->art_id ? TRUE : FALSE) // Artifacts use the "art_id" field
...
#define GET_SE_LEFT_RIGHT_SWITCHING 0x00000200
#define GET_SE_VIEW_ONLY   0x00000400
