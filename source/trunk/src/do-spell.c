...
void cast_wonder(creature_type *caster_ptr, TRAIT_ID trait_id)
{
	...
	else if(die < 81) cast_ball_aux(caster_ptr, y, x, DO_EFFECT_ELEC, 30 + lev_bonus / 2, 2, trait_id);
	else if(die < 86) cast_ball_aux(caster_ptr, y, x, DO_EFFECT_ACID, 40 + lev_bonus, 2, trait_id);
	else if(die < 91) cast_ball_aux(caster_ptr, y, x, DO_EFFECT_ICE, 70 + lev_bonus, 3, trait_id);
	else if(die < 96) cast_ball_aux(caster_ptr, y, x, DO_EFFECT_FIRE, 80 + lev_bonus, 3, trait_id);
...
void cast_invoke_spirits(creature_type *caster_ptr)
{
	...
	else if(die < 91) cast_ball_aux(caster_ptr, y, x, DO_EFFECT_ICE, 70 + lev_bonus, 3, -1);
	else if(die < 96) cast_ball_aux(caster_ptr, y, x, DO_EFFECT_FIRE, 80 + lev_bonus, 3, -1);
