...
static cptr do_sorcery_spell(creature_type *caster_ptr, int spell, int mode)
{
	...
	case 12:
    ...
    
		{
			...
			{
				if(!get_aim_dir(caster_ptr, MAX_RANGE_SUB, &dir)) return NULL;
				cast_beam(caster_ptr, MAX_RANGE_SUB, DO_EFFECT_AWAY_ALL, power, 0);
			}
		}
		break;
...
static cptr do_nature_spell(creature_type *caster_ptr, int spell, int mode)
{
	...
	case 1:
    ...
    
		{
			...
			{
				if(!get_aim_dir(caster_ptr, MAX_RANGE_SUB, &dir)) return NULL;
				cast_beam(caster_ptr, range, DO_EFFECT_ELEC, diceroll(dice, sides), 0);
			}
		}
		break;
...
static cptr do_chaos_spell(creature_type *caster_ptr, int spell, int mode)
{
	...
	case 11:
    ...
    
		{
			...
			if(cast)
			{
				...
				cast_beam(caster_ptr, MAX_RANGE_SUB, DO_EFFECT_MANA, diceroll(dice, sides), 0);
			}
		}
		break;
	...
	case 17:
    ...
    
		{
			...
			{
				for (dir = 0; dir <= 9; dir++)
					cast_beam(caster_ptr, MAX_RANGE_SUB, DO_EFFECT_ELEC, diceroll(dice, sides), 0);
			}
		}
		break;
	...
	case 24:
    ...
    
		{
			...
			if(cast)
			{
				...
				cast_beam(caster_ptr, MAX_RANGE_SUB, DO_EFFECT_GRAVITY, diceroll(dice, sides), 0);
			}
		}
		break;
...
static cptr do_crusade_spell(creature_type *creature_ptr, int spell, int mode)
{
	...
	case 14:
    ...
    
		{
			...
			{
				if(!get_aim_dir(creature_ptr, MAX_RANGE_SUB, &dir)) return NULL;
				cast_bolt(creature_ptr, DO_EFFECT_ELEC, MAX_RANGE_SUB, dam, 0);
			}
		}
		break;
...
static cptr do_music_spell(creature_type *caster_ptr, int spell, int mode)
{
	...
	case 22:
    ...
    
		{
			...
			{
				if(!get_aim_dir(caster_ptr, MAX_RANGE_SUB, &dir)) return NULL;
				cast_beam(caster_ptr, MAX_RANGE_SUB, DO_EFFECT_SOUND, diceroll(dice, sides), 0);
			}
		}
		break;
...
static cptr do_hissatsu_spell(creature_type *caster_ptr, int spell, int mode)
{
	...
	case 0:
		...
		if(cast)
		{
			...
			projection(caster_ptr, MAX_RANGE_SUB,DO_EFFECT_ATTACK, dir, HISSATSU_2, PROJECT_STOP | PROJECT_KILL);
		}
		break;
	...
	case 21:
		...
		if(cast)
		{
			...
			cast_beam(caster_ptr, MAX_RANGE_SUB, DO_EFFECT_FORCE, total_damage, 0);
		}
		break;
