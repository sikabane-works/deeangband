...
extern int calc_damage(creature_type *attacker_ptr, creature_type *target_ptr, int damage, int type, bool message, bool average);
...
extern int get_selection(selection_table *se_ptr, int num, int default_se, int y, int x, int h, int w, void(*)(int), s32b mode);
extern int get_multi_selection(selection_table *se_ptr, int num, int y, int x, int h, int w, void(*detail)(int), u32b *ret);
