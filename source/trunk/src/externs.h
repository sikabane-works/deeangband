...
/* melee1.c */
/* melee2.c */
extern bool special_melee(creature_type *atk_ptr, creature_type *tar_ptr, int ap_cnt);
...
extern bool get_item(creature_type *creature_ptr, int *cp, cptr pmt, cptr str, int mode, bool (*hook)(creature_type *cr_ptr, object_type *o_ptr));
...
extern s16b get_obj_num(floor_type *floor_ptr, u32b flags);
