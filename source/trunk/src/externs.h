...
// melee2.c
extern void breath(int y, int x, creature_type *caster_ptr, int typ, int dam_hp, int rad, int trait_id);
...
extern bool cast_bolt_or_beam(creature_type *caster_ptr, int typ, int range, int dir, int dam, int prob);
...
extern bool projection(creature_type *caster_ptr, int range, int typ, int dir, int dam, int flg);
