...
extern byte adj_dex_to_ac[STAT_TABLE_SIZE];
extern byte adj_str_to_damage[STAT_TABLE_SIZE];
extern byte adj_dex_to_hit[STAT_TABLE_SIZE];
extern byte adj_str_to_hit[STAT_TABLE_SIZE];
...
extern byte adj_con_mhp[STAT_TABLE_SIZE];
