...
extern FLAGS_32 option_flag[8];
extern FLAGS_32 option_mask[8];
extern FLAGS_32 window_flag[8];
extern FLAGS_32 window_mask[8];
...
extern creature_type* generate_creature(cave_type *c_ptr, s16b species_idx, u32b flags);
...
extern void add_item_to_creature(creature_type *creature_ptr, object_type *object_ptr, u32b flags);
...
extern void prt_path(creature_type *creature_ptr, int range, int y, int x);
...
extern s16b critical_shot(creature_type *creature_ptr, int weight, int plus, POWER dam);
...
// melee2.c
extern void breath(creature_type *caster_ptr, int typ, int range, POWER dam_hp, int rad, int trait_id);
...
extern bool binding_field(creature_type *caster_ptr, int range, POWER dam);
...
extern bool cast_bolt(creature_type *caster_ptr, int typ, int range, POWER dam, int trait_id);
extern bool cast_ball(creature_type *caster_ptr, int typ, COODINATES range, POWER dam, COODINATES rad);
extern bool cast_grenade(creature_type *caster_ptr, int typ, int range, POWER dam, int rad);
extern bool cast_ball_hide(creature_type *caster_ptr, int typ, int range, POWER dam, int rad);
...
extern bool cast_beam(creature_type *caster_ptr, int typ, int range, POWER dam, int trait_id);
extern bool cast_bolt_or_beam(creature_type *caster_ptr, int typ, int range, POWER dam, int prob);
...
extern void prepare_update(creature_type *creature_ptr, u32b flags);
