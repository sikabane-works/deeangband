...
extern u16b max_creature_egobject_idx;
...
extern void clear_creature_lite(void);
...
extern bool species_can_enter(int y, int x, species_type *r_ptr, u16b mode);
...
extern void delete_creature(int y, int x);
...
extern bool place_creature_aux(creature_type *summoner_ptr, int y, int x, int species_idx, u32b mode);
extern bool place_creature(creature_type *summoner_ptr, int y, int x, u32b mode);
extern void deal_item(creature_type *creature_ptr);
extern bool alloc_horde(creature_type *summoner_ptr, int y, int x);
extern bool alloc_guardian(bool def_val);
extern bool alloc_creature(creature_type *player_ptr, int dis, u32b mode);
...
extern int get_selection(selection *se_ptr, int num, int default_se, int y, int x, int h, int w, void(*)(int));
...
extern bool monster_arena_mode;		/* Is character inside tougijou? */
