...
static void player_flags(u32b flgs[TR_FLAG_SIZE], creature_type *creature_ptr)
{
	...
	{
		remove_flag(flgs, TRAIT_REGENERATE);
	}
...
static void display_creature_flag_info3(creature_type *creature_ptr)
{
	...
	display_flag_aux(row+ 9, col, "祝福        :", TRAIT_BLESSED_BRANDED, &f, 0, creature_ptr);
	...
	display_flag_aux(row+ 9, col, "Blessed     :", TRAIT_BLESSED_BRANDED, &f, 0, creature_ptr);
