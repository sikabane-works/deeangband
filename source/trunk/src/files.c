...
static named_num gf_desc[] =
{
	...
	{"DO_EFFECT_CLONE", DO_EFFECT_CLONE},
	{"DO_EFFECT_POLY", DO_EFFECT_POLY},
	{"DO_EFFECT_HEAL", DO_EFFECT_HEAL},
	{"DO_EFFECT_HASTE", DO_EFFECT_HASTE},
	{"DO_EFFECT_SLOW", DO_EFFECT_SLOW},
	{"DO_EFFECT_CONF_OTHERS", DO_EFFECT_CONF_OTHERS},
	{"DO_EFFECT_SLEEP", DO_EFFECT_SLEEP},
	{"DO_EFFECT_DRAIN", DO_EFFECT_DRAIN},
	...
	{"DO_EFFECT_CURSE", DO_EFFECT_CURSE},
	{"DO_EFFECT_KEIRAKU", DO_EFFECT_KEIRAKU},
	...
	{"DO_EFFECT_HOLD_EVIL", DO_EFFECT_HOLD_EVIL},
	{"DO_EFFECT_WOUNDS", DO_EFFECT_WOUNDS},
	{"DO_EFFECT_ACID_FLOW", DO_EFFECT_ACID_FLOW},
	{"DO_EFFECT_POISON_FLOW", DO_EFFECT_POISON_FLOW},
	{"DO_EFFECT_WANDER", DO_EFFECT_WANDER},
	{"DO_EFFECT_RUMOR", DO_EFFECT_RUMOR},
	{"DO_EFFECT_TIMESTOP", DO_EFFECT_TIMESTOP},
	{"DO_EFFECT_DISPEL", DO_EFFECT_DISPEL},
	{"DO_EFFECT_TRY_LIVINGTRUMP", DO_EFFECT_TRY_LIVINGTRUMP},
	{"DO_EFFECT_VOMITING", DO_EFFECT_VOMITING},
	{"DO_EFFECT_REMOVE_CURSE_1", DO_EFFECT_REMOVE_CURSE_1},
	{"DO_EFFECT_REMOVE_CURSE_2", DO_EFFECT_REMOVE_CURSE_2},
	{"DO_EFFECT_SATIATE", DO_EFFECT_SATIATE},
	{"DO_EFFECT_AGGRAVATE", DO_EFFECT_AGGRAVATE},
	{"DO_EFFECT_MIRROR_SET", DO_EFFECT_MIRROR_SET},
	{"DO_EFFECT_IMPROVE_FORCE", DO_EFFECT_IMPROVE_FORCE},
	{"DO_EFFECT_GAIN_EXP", DO_EFFECT_GAIN_EXP},
	{"DO_EFFECT_RESTORE_EXP", DO_EFFECT_RESTORE_EXP},
	{NULL, 0}
};
...
static void print_tomb(creature_type *creature_ptr)
{
	...
	if(!done)
	{
		...
		if(!streq(gameover_from, COD_RETIRE) && !streq(gameover_from, COD_SEPPUKU))
		{
			...
			{
				if(streq(gameover_from, COD_QUITTING)) sprintf(tmp, "%sで死んだ", KW_SURFACE);
				else sprintf(tmp, "に%sで殺された", KW_SURFACE);
			}
			else
			{
