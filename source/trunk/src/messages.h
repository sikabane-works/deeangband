...
#define KW_PRE_OFFER_PRICE "前回の提示金額"
...
#define KW_PET "ペット"
#define KW_FRIEND "友軍"
#define KW_TODAY_TARGET "今日のターゲット"
#define KW_CLONE "クローン"
...
#define KW_TODAY_TARGET "Today Target"
#define KW_CLONE "Clone"
