...
#define SYS_MESSAGE_QUITING_KEY "リターンキーか ESC キーを押して下さい。"
...
#define SYS_MESSAGE_QUITING_KEY "Press Return (or Escape)."
...
#define SYS_MESSAGE_PANIC "Panic"
