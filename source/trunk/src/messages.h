...
#define GAME_MESSAGE_TRAP_EXPROSIVE "突然、箱が爆発した！箱の中の物はすべて粉々に砕け散った！"
...
#define GAME_MESSAGE_TRAP_EXPROSIVE "There is a sudden explosion! Everything inside the chest is destroyed!"
