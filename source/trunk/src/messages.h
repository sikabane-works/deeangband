...
#if JP
#else
#define get_keyword("KW_CURSOR") ">>"
#define get_keyword("KW_MORE") "-more-"
#define get_keyword("KW_CREATURE") "creatures"
#define get_keyword("KW_WEIRD_CREATURE") "weird creatures"
#define get_keyword("KW_NAME") "Name"
...
#define get_keyword("KW_AC") "AC"
#define get_keyword("KW_EV") "EV"
#define get_keyword("KW_VO") "VO"
...
#define get_keyword("KW_FAIL") "Fail"
#define get_keyword("KW_EFFECT") "Effect"
#define get_keyword("KW_STRANGE") "Strange"
#define get_keyword("KW_FORGOTTEN") "Forgotten"
#define get_keyword("KW_ILLEGIBLE") "Illegible"
#define get_keyword("KW_UNTRIED") "Untried"
#define get_keyword("KW_INVENTORY "Inventory"
#define get_keyword("KW_EQUIPMENT "Equipment"
#define get_keyword("KW_HOME "Home"
#define get_keyword("KW_CARRYING_WEIGHT") "Carrying Weight"
#define get_keyword("KW_EQUIPMENT_WEIGHT") "Equipment Weight"
#define get_keyword("KW_STAFF "staff"
#define get_keyword("KW_WAND "wand"
#define get_keyword("KW_ROD "rod"
#define get_keyword("KW_YOU "You"
#define get_keyword("KW_CREATURE_PROFILE "Creature Profile"
#define get_keyword("KW_CREATURE_PROFILE_EDITING") "Creature Profile - Edit Mode"
#define  get_keyword("KW_CREATURE_PROFILE_EDITED") "Creature Profile - Edited"
#define get_keyword("KW_GOOD "Good"
#define get_keyword("KW_EVIL "Evil"
#define get_keyword("KW_LAW "Law"
#define get_keyword("KW_CHAOS "Chaos"
#define get_keyword("KW_BALANCE "Balance"
#define get_keyword("KW_DAM "Dam"
#define get_keyword("KW_RAN "Ran"
#define get_keyword("KW_POW "Pow"
#define get_keyword("KW_RAD "Rad"
#define get_keyword("KW_YES") "Yes"
#define get_keyword("KW_NO") "No"
#define get_keyword("KW_DONE "Done"
#define get_keyword("KW_SURE "Sure"
#define get_keyword("KW_NOTHING") "Nothing"
#define get_keyword("KW_CANCEL "Cancel"
#define get_keyword("KW_FAILED") "Failed"
#define get_keyword("KW_NONE") "None"
#define get_keyword("KW_SURFACE "the surface"
#define get_keyword("KW_QUEST "quest"
#define get_keyword("KW_SCORE_RANKING") "Hall of Fame"
#define get_keyword("KW_WINNER") "Magnificent"
#define get_keyword("KW_MAX "Max"
#define get_keyword("KW_RANDOM "Random"
#define get_keyword("KW_BACK_TO_START "Back to start"
#define get_keyword("KW_QUIT_GAME "Quit game"
#define get_keyword("KW_ACCEPT "Accept"
#define get_keyword("KW_IT "It"
#define get_keyword("KW_SOMETHING "Something"
#define get_keyword("KW_CLONE "Clone"
#define get_keyword("KW_VALIABLE_RACE "VariableRace"
#define get_keyword("KW_VALIABLE_CLASS "VariableClass"
#define get_keyword("KW_VALIABLE_CHARA "VariableChara"
#define get_keyword("KW_MALE "Male"
#define get_keyword("KW_FEMALE "Female"
#define get_keyword("KW_INTERSEX "Intersex"
#define get_keyword("KW_NOSEX") "Nosex"
#define get_keyword("KW_LORD "Lord"
#define get_keyword("KW_KING "King"
#define get_keyword("KW_QUEEN "Queen"
#define get_keyword("KW_FAST "Fast"
#define get_keyword("KW_SLOW "Slow"
#define get_keyword("KW_RIDING "Riding"
#define get_keyword("KW_OFFER "Offer"
#define get_keyword("KW_ASKING_PRICE "Asking Price"
#define get_keyword("KW_FINAL_OFFER_PRICE "Final Offer"
#define get_keyword("KW_PRE_OFFER_PRICE "Your last offer"
#define get_keyword("KW_FLOOR_NUM(NUM) "Floor %d", (NUM)
#define get_keyword("KW_FLOOR_NUM2(DUNGEON, NUM) "%s L%d:", (DUNGEON), (NUM)
#define get_keyword("KW_DEAD "dead"
#define get_keyword("KW_ALIVE "alive"
#define get_keyword("KW_UNIDENTIFIED "unidentified"
#define get_keyword("KW_EMPTY "empty"
#define get_keyword("KW_TRIED "tried"
#define get_keyword("KW_PRICE_OFF "%off"
#define get_keyword("KW_HISSATSU "Art"
#define get_keyword("KW_SONG "Song"
#define get_keyword("KW_MIRACLE "Miracle"
#define get_keyword("KW_SPELL "Spell"
#define get_keyword("KW_STUDY "Study"
#define get_keyword("KW_SOMETHING_STRANGE "something strange"
#define get_keyword("KW_NOTHING_TARGET") "nothing"
#define get_keyword("KW_UNEXPLORED_ZONE "unexplored zone"
#define get_keyword("KW_ROAD "road"
#define get_keyword("KW_MESSAGE "message"
#define get_keyword("KW_WINNING_MESSAGE "*Winning* message"
#define get_keyword("KW_LEAVE "Leave"
#define get_keyword("KW_DESTROY "Destroy"
#define get_keyword("KW_PICKUP "Pickup"
#define get_keyword("KW_QUERY "Query"
#define get_keyword("KW_TRY "Try"
#define get_keyword("KW_FEATURE "Feature"
#define get_keyword("KW_CAMOUFLAGE "Camouflage"
#define get_keyword("KW_QUANTITY "Quantity"
#define get_keyword("KW_KILLS "Kills"
#define get_keyword("KW_SYM "Sym"
#define get_keyword("KW_PET "Pet"
#define get_keyword("KW_FRIEND "Friend"
#define get_keyword("KW_TODAY_TARGET "Today Target"
#define get_keyword("KW_CLONE "Clone"
#define get_keyword("KW_WANTED "Wanted"
#define get_keyword("KW_CHARGING "(charging)""
#define get_keyword("KW_FLOORITEM "On a floor"
#define get_keyword("KW_WITH_THOHANDED "(wielding with two-hands)"
#define get_keyword("KW_CHARA")_INVENTORY "Character inventory"
#define get_keyword("KW_CHARA")_EQUIPMENT "Character Equipment"
#define get_keyword("KW_MUSIUM_LIST "Museum"
#define get_keyword("KW_JUST_LIFTING "Just lifting"
#define get_keyword("KW_SHOOTING "Shooting"
#define get_keyword("KW_UNKNOWN "UNKNOWN"
#define get_keyword("KW_SOMEONE "It"
#define get_keyword("KW_BODY "body"
#define get_keyword("KW_WORLD_MAP "The Surface of Chaos"
#define get_keyword("KW_ARENA "Arena"
#define get_keyword("KW_AUTOSAVE "Autosave"
#define get_keyword("KW_VARIABLE_SIZE "VariableSize"
#define get_keyword("KW_ENEMY "the enemy"
#define get_keyword("KW_LAST_WORD "Last word"
#define get_keyword("KW_LAST_POET "Last poet"
#define get_keyword("KW_UNDEFINED "undefined"
#define get_keyword("KW_HELPFILE "Help file"
#define get_keyword("KW_POWER "Power"
#define get_keyword("KW_SUICIDE "Suicide"
#define get_keyword("KW_CHARGES "Charges"
#define get_keyword("KW_COMMAND "Command"
#define get_keyword("KW_CURRENT_LIFERATE "Current Life Rating"
#define get_keyword("KW_CURSED "cursed"
#endif
...
#define MES_COMBAT_TALK_BULLSHIT "くっそ～！"
#define MES_CHARGEMAN_TALK_JURAL "ジュラル星人の仕業に違いない！"
...
#define MES_COMBAT_TALK_BULLSHIT "Bullshit!"
#define MES_CHARGEMAN_TALK_JURAL "'It's must be handiwork of Jurals!'"
...
#define MES_SUMMON_DEMON_FUMBLE "「卑しき者よ、我は汝の下僕にあらず！ お前の魂を頂くぞ！」"
#define MES_SUMMON_DEMON_FAILURE "悪魔は現れなかった。"
#define MES_SUMMON_ELEMENTAL_FAILED "エレメンタルは現れなかった。"
#define MES_SUMMON_GOLEM_SUCCESS "ゴーレムを作った。"
#define MES_SUMMON_GOLEM_FAILURE "うまくゴーレムを作れなかった。"
#define MES_SUMMON_MANES_FAILURE "古代の死霊は現れなかった。"
#define MES_SUMMON_TRUMP_SPIDER "あなたは蜘蛛のカードに集中する..."
#define MES_SUMMON_TRUMP_ANIMAL "あなたは動物のカードに集中する..."
#define MES_SUMMON_TRUMP_KAMIKAZE "あなたはカミカゼのカードに集中する..."
#define MES_SUMMON_TRUMP_UNDEAD "あなたはアンデッドのカードに集中する..."
#define MES_SUMMON_TRUMP_REPTILE "あなたは爬虫類のカードに集中する..."
#define MES_SUMMON_TRUMP_CREATURE "あなたはクリーチャーのカードに集中する..."
#define MES_SUMMON_TRUMP_HOUND "あなたはハウンドのカードに集中する..."
#define MES_SUMMON_TRUMP_CYBER_DEMON "あなたはサイバーデーモンのカードに集中する..."
#define MES_SUMMON_TRUMP_DRAGON "あなたはドラゴンのカードに集中する..."
#define MES_SUMMON_TRUMP_DEMON "あなたはデーモンのカードに集中する..."
#define MES_SUMMON_TRUMP_GREATER_UNDEAD "あなたは強力なアンデッドのカードに集中する..."
#define MES_SUMMON_TRUMP_ANCIENT_DRAGON "あなたは古代ドラゴンのカードに集中する..."
#else
...
#define MES_SUMMON_DEMON_FUMBLE "'NON SERVIAM! Wretch! I shall feast on thy mortal soul!'"
#define MES_SUMMON_DEMON_FAILURE "No demons arrive."
#define MES_SUMMON_ELEMENTAL_FAILED "No Elementals arrive."
#define MES_SUMMON_GOLEM_SUCCESS "You make a golem."
#define MES_SUMMON_GOLEM_FAILURE "You failed to make a golem."
#define MES_SUMMON_MANES_FAILURE "No Manes arrive."
#define MES_SUMMON_TRUMP_SPIDER "You concentrate on the trump of a spider..."
#define MES_SUMMON_TRUMP_ANIMAL "You concentrate on the trump of an animal..."
#define MES_SUMMON_TRUMP_KAMIKAZE "You concentrate on several trumps at once..."
#define MES_SUMMON_TRUMP_UNDEAD "You concentrate on the trump of an undead creature..."
#define MES_SUMMON_TRUMP_REPTILE "You concentrate on the trump of a reptile..."
#define MES_SUMMON_TRUMP_CREATURE "You concentrate on several trumps at once..."
#define MES_SUMMON_TRUMP_HOUND "You concentrate on the trump of a hound..."
#define MES_SUMMON_TRUMP_CYBER_DEMON "You concentrate on the trump of a Cyberdemon..."
#define MES_SUMMON_TRUMP_DRAGON "You concentrate on the trump of a dragon..."
#define MES_SUMMON_TRUMP_DEMON "You concentrate on the trump of a demon..."
#define MES_SUMMON_TRUMP_GREATER_UNDEAD "You concentrate on the trump of a greater undead being..."
#define MES_SUMMON_TRUMP_ANCIENT_DRAGON "You concentrate on the trump of an ancient dragon..."
#endif
...
#define MES_OBJECT_CANT_DESTROY(OBJECT) "You cannot auto-destroy %s.", (OBJECT)->name
#endif
...
#define MES_RECALL_CHOICE "ここは最深到達階より浅い階です。この階に戻って来ますか？ "
#else
...
#define MES_RECALL_CHOICE "Reset recall depth? "
#endif
...
#define MES_EFFECT_MIND_COUNTERDRAIN "超能力パワーを吸いとられた！"
...
#define MES_EFFECT_MIND_COUNTERDRAIN "Your psychic energy is drained!"
...
#define MES_BIRTH_SECOND_RACE "第二種族を選択して下さい:"
...
#define MES_BIRTH_SUB_RACE_MODIFY "の副種族修正"
#define MES_BIRTH_ELDAR "エルダールの副種族を選択して下さい:"
#define MES_BIRTH_DRAGONBONE "竜族の副種族を選択して下さい:"
#define MES_BIRTH_SEX "性別を選択して下さい(赤字の性別には種族ペナルティがかかります):"
#define MES_BIRTH_CLASS "職業を選択して下さい(緑字の職業には種族相性ボーナスがつきます):"
#define MES_BIRTH_BASE_LEVEL_DR "基礎レベル:   基礎神格:"
#else
...
#define MES_BIRTH_SECOND_RACE "Select second race:"
...
#define MES_BIRTH_SUB_RACE_MODIFY "'s Sub-Race modification"
#define MES_BIRTH_ELDAR "Select a sub-race of Eldar:"
#define MES_BIRTH_DRAGONBONE "Select a sub-race of Dragonbone:"
#define MES_BIRTH_SEX "Select a sex(Red entries have race penalty) "
#define MES_BIRTH_CLASS "Select a class(Any green entries have race bonus):"
#define MES_BIRTH_BASE_LEVEL_DR "Base Level:   Base DR :"
#endif

#ifdef JP
#define MES_DUNGEON_INFO(NAME, LEVEL) "%s(%d階相当)", (NAME), (LEVEL)
#define MES_DUNGEON_QUESTED(DUNGEON) "あなたは%sを制覇した！", dungeon_name + (DUNGEON)->name
#define MES_DUNGEON_LIST(CLEARED, NAME, LEVEL) "%c%-12s :  %3d 階\n", (CLEARED), (NAME), (LEVEL)
#define MES_DUNGEON_LIST2(SYM, CLEARED, NAME, LEVEL) "      %c) %c%-12s : 最大 %d 階", (SYM), (CLEARED), (NAME), (LEVEL)
#define MES_DUNGEON_NO_ENTERED(DUNGEON) "まだ%sに入ったことはない。", dungeon_name + (DUNGEON)->name
#define MES_DUNGEON_RESET_LEVEL(MIN, MAX) "何階にセットしますか (%d-%d)", (MIN), (MAX)
#else
...
#define MES_CREATURE_ANGER(CREATURE) "%^sは怒った！", (CREATURE)->name
#define MES_CREATURE_FAINT_HUNGRY "あまりにも空腹で気絶してしまった。"
#else
...
#define MES_INTERFACE_RES_LIST_UNKNOWN "-------不明--------------- -------不明---------\n"
#define IM_FLAG_STR  "＊"
#define HAS_FLAG_STR "＋"
#define NO_FLAG_STR  "・"
...
#define MES_INTERFACE_RES_LIST_UNKNOWN "-------unknown------------ -------unknown------\n"
#define IM_FLAG_STR  "* "
#define HAS_FLAG_STR "+ "
#define NO_FLAG_STR  ". "
...
#define MES_MELEE_EMPTY "攻撃は空を切った。"
...
#define MES_MELEE_FORCE_AURA(CREATURE) "%^sは鋭い闘気のオーラで傷ついた！", (CREATURE)->name
#define MES_MELEE_SHADOW_AURA(CREATURE) "影のオーラが%^sに反撃した！", (CREATURE)->name
...
#define MES_MELEE_EATEN(OBJECT, ID, NUM) "%s(%c)を%s食べられた。", (OBJECT)->name, index_to_label(ID), ((NUM) > 1) ? "一つ" : ""
...
#define MES_MELEE_FORCE_AURA(CREATURE) "%^s is injured by the force", (CREATURE)->name
#define MES_MELEE_SHADOW_AURA(CREATURE) "Enveloped shadows attack %^s.", (CREATURE)->name
...
#define MES_MELEE_EATEN(OBJECT, ID, NUM) ("%sour %s (%c) was eaten.", (((NUM) > 1) ? "One of y" : "Y"), (OBJECT), index_to_label(ID))
...
#define MES_SPELL_FAILED2 "集中に失敗した！"
...
#define MES_SPELL_LEARNED(REALM, SPELL) "%sの%sを学んだ。", (REALM), (SPELL)
#define MES_SPELL_LEARNED_BLUE(SPELL) "%sを学習した。", (SPELL)
#else
...
#define MES_SPELL_FAILED2 "You failed to concentrate hard enough!"
...
#define MES_SPELL_LEARNED(REALM, SPELL) "You have learned the %s of %s.", (REALM), (SPELL)
#define MES_SPELL_LEARNED_BLUE(SPELL) "You have learned %s.", (SPELL)
#endif
...
#define MES_OBJECT_WASTE_FOOD "もったいない事をしたような気がする。食べ物は大切にしなくては。"
#define MES_OBJECT_CHANGE_HAND(OBJECT) "%sを持ち替えた。", (OBJECT)->name
#else
...
#define MES_OBJECT_WASTE_FOOD "What a waste.  It's your food!"
#define MES_OBJECT_CHANGE_HAND(OBJECT) "You switched hand of %s.", (OBJECT)->name
#endif
...
#define MES_TIME_NIGHTMARE_MIDNIGHT_3 "遠くで鐘が三回鳴った。"
#define MES_TIME_NIGHTMARE_MIDNIGHT_4 "遠くで鐘が四回鳴った。"
#define MES_TIME_NIGHTMARE_MIDNIGHT_DONE "遠くで鐘が何回も鳴り、死んだような静けさの中へ消えていった。"
#else
...
#define MES_TIME_NIGHTMARE_MIDNIGHT_2 "A distant bell sounds twice."
#define MES_TIME_NIGHTMARE_MIDNIGHT_3 "A distant bell sounds three times."
#define MES_TIME_NIGHTMARE_MIDNIGHT_4 "A distant bell sounds tolls four times.."
#endif
...
#define MES_DIARY_WHEN_RECALL "帰還のときに"
...
#define MES_DIARY_WHEN_RECALL "when recall from dungeon"
...
#define MES_DIARY_RECORD_OBJECT(OBJECT) "%sの入手を記録します。", (OBJECT)->name
#else
...
#define MES_PET_CAPTURED(PET) "%sを捕えた！", (PET)->name
#define MES_PET_CAPTURE_FAILED(PET) "%sをうまく捕まえられなかった。", (PET)->name
#define MES_PET_NEED_WEAKEN(TARGET) "%sはもっと弱らせないと捕獲できない。", (TARGET)->name
...
#define MES_STEED_FALL_DOWN(STEED) "%^sから落ちてしまった！", (STEED)->name
...
#define MES_PET_CAPTURED(PET) "You capture %^s!", (PET)->name
#define MES_PET_CAPTURE_FAILED(PET) "You failed to capture %s.", (PET)->name
#define MES_PET_NEED_WEAKEN(TARGET) "You need to weaken %s more.", (TARGET)->name
...
#define MES_STEED_FALL_DOWN(STEED) "You have fallen from %s.", (STEED)->name
...
#define MES_TRAIT_PRECOG_NO_DANGER "安全な気がする。"
...
#define MES_TRAIT_TELEPORT_BACK(TARGET) "%sを引き戻した。", (TARGET)
...
#define MES_TRAIT_DIVIDE(CREATURE) "%sは分裂した！", (CREATURE)->name
...
#define MES_TRAIT_GENE_ALREADY(OBJECT) "%sは既に伝説のアイテムです！", (OBJECT)->name
...
#define MES_TRAIT_MOON_DAZZLING_DONE "武器を不規則に揺らした．．．"
#define MES_TRAIT_WARNING_DONE(OBJECT) "%sが鋭く震えた！", (OBJECT)->name
#define MES_TRAIT_WARNING_DONE2(OBJECT) "%sが震えた！", (OBJECT)->name
#define MES_TRAIT_SHADOW_MOVE_FAILED "影移動に失敗した。"
#define MES_TRAIT_CANNOT_SWAP "それとは場所を交換できません。"
#define MES_TRAIT_KAWARIMI_SUCCESS(CREATURE) "%sは攻撃を受ける前に素早く身をひるがえした。", (CREATURE)->name
...
#define MES_TRAIT_ATTRACT_DRAGON(CREATURE) "%sはドラゴンを引き寄せた。", (CREATURE)->name
#define MES_TRAIT_HASTE_FLUX(CREATURE) "%sは精力的でなくなった気がする。", (CREATURE)->name
#define MES_TRAIT_HASTE_FLUX2(CREATURE) "%sは精力的になった気がする。", (CREATURE)->name
#else
...
#define MES_TRAIT_PRECOG_NO_DANGER "You feel safe."
...
#define MES_TRAIT_GENE_ALREADY(OBJECT) "The %s %s already %s!", (OBJECT)->name, (((OBJECT)->number > 1) ? "are" : "is"), (((OBJECT)->number > 1) ? "artifacts" : "an artifact"
...
#define MES_TRAIT_ATTRACT_DRAGON(CREATURE) "%s had attracted a dragon.", (CREATURE)->name
#define MES_TRAIT_HASTE_FLUX(CREATURE) "%s felt less energetic.", (CREATURE)->name
#define MES_TRAIT_HASTE_FLUX2(CREATURE) "%s felt more energetic.", (CREATURE)->name
#endif
...
#define MES_POSTURE_LOST_ASSUMED "構えが崩れた。"
#else
...
#define MES_POSTURE_LOST_ASSUMED "Your posture gets loose."
#endif

#ifdef JP
#define MES_PSIONIC_FAILED_MANASTORM(SKILL_NAME) "%sの力が制御できない氾流となって解放された！", (SKILL_NAME)
#define MES_PSIONIC_SELF_DAMAGED "自分の精神を攻撃してしまった！"
#else
...
#define MES_OBJ_DESC_CHARGING(NUM) " (%d本 充填中)", (NUM)
#else
...
#ifdef JP
#define MES_CREATE_AMMO_NO_ROCK "そこには岩石がない。"
#define MES_CREATE_AMMO_TOO_HARD "硬すぎて掘れなかった。"
#else
...
#define MES_FOOD_CORPSE(OBJECT) "%sは燃え上り灰になった。精力を吸収した気がする。", (OBJECT)->name
#define MES_OBJECT_MUST_GET_STUFF "まずは杖を拾わなければ。"
#define MES_FOOD_ABSORB_MAGIC(OBJECT) "あなたは%sの魔力をエネルギー源として吸収した。", (OBJECT)->name
#else
...
#define MES_OBJECT_MUST_GET_STUFF "You must first pick up the staffs."
...
#define MES_INFO_STATUS_LIMIT "能力の限界値"
...
#define MES_INFO_STATUS_LIMIT "Limits of maximum stats"
...
#define MES_SCORE_RETRY "もう一度接続を試みますか? "
...
#define MES_SCORE_RETRY "Try score senfing again? "
...
#define OBJECT_DESC_STAFF_A "%の杖"
#define OBJECT_DESC_STAFF_B "%の#杖"
#define OBJECT_DESC_STAFF_C "#杖"
#define OBJECT_DESC_WAND_A "%の魔法棒"
#define OBJECT_DESC_WAND_B "%の#魔法棒"
#define OBJECT_DESC_WAND_C "#魔法棒"
...
#define OBJECT_DESC_FOOD_A "%のキノコ"
...
#define OBJECT_DESC_TRUMP_BOOK "トランプの魔法書%"
#define OBJECT_DESC_ARCANE_BOOK "秘術の魔法書%"
#define OBJECT_DESC_CRAFT_BOOK "匠の魔法書%"
#define OBJECT_DESC_DAEMON_BOOK "悪魔の魔法書%"
#define OBJECT_DESC_CRUSADE_BOOK "破邪の魔法書%"
...
#define OBJECT_DESC_STAFF_A "& Staff~ of %"
#define OBJECT_DESC_STAFF_B "& # Staff~ of %"
#define OBJECT_DESC_STAFF_C "& # Staff~"
#define OBJECT_DESC_WAND_A "& Wand~ of %"
#define OBJECT_DESC_WAND_B "& # Wand~ of %"
#define OBJECT_DESC_WAND_C "& # Wand~"
...
#define OBJECT_DESC_TRUMP_BOOK "& Trump Spellbook~ %"
#define OBJECT_DESC_ARCANE_BOOK "& Arcane Spellbook~ %"
#define OBJECT_DESC_CRAFT_BOOK "& Craft Spellbook~ %"
#define OBJECT_DESC_DAEMON_BOOK "& Daemon Spellbook~ %"
#define OBJECT_DESC_CRUSADE_BOOK "& Crusade Spellbook~ %"
...
#ifdef JP
#define MES_SPOILER_EVOL1(SPECIES_ID, NAME, LEV, SYM) "[%d]: %s (レベル%d, '%c')\n", (SPECIES_ID), (NAME), (LEV), (SYM)
#define MES_SPOILER_EVOL2(NAME, LEV, SYM) "%s (レベル%d, '%c')\n", (NAME), (LEV), (SYM)
#else
...
#ifdef JP
#define MES_STEALTH_SHADOW_ON "敵の目から薄い影の中に覆い隠された。"
#define MES_STEALTH_SHADOW_OFF "敵の目から影の中に覆い隠された！"
#else
...
#ifdef JP
#define MES_TIME_RESTART "「時は動きだす…」"
#else
...
#define MES_TASK_SPELL_STOP "呪文の念唱を中断した。"
...
#define MES_TASK_LEARNING_LOST "You cannot continue Learning!"
...
#define MES_TASK_SINGING_STOP "You stop singing."
