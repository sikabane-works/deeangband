...
{
{
	"近くの全ての見えるクリーチャーを感知する。レベル5で罠/扉、15で透明なクリーチャー、30で財宝とアイテムを感知できるようになる。レベル20で周辺の地形を感知し、45でその階全体を永久に照らし、ダンジョン内のすべてのアイテムを感知する。レベル25で一定時間テレパシーを得る。",
	"精神攻撃のビームまたは球を放つ。",
	"近距離のテレポートをする。",
	"遠距離のテレポートをする。",
	"レベル30未満で、クリーチャーを朦朧か混乱か恐怖させる球を放つ。レベル30以上で視界内の全てのクリーチャーを魅了する。抵抗されると無効。",
	"テレキネシスの球を放つ。",
	"一定時間、ACを上昇させる。レベルが上がると、酸、炎、冷気、電撃、毒の耐性も得られる。",
	"レベル25未満で、アイテムの雰囲気を知る。レベル25以上で、アイテムを鑑定する。",
	"レベル25未満で、自分を中心とした精神攻撃の球を発生させる。レベル25以上で、視界内の全てのクリーチャーに対して精神攻撃を行う。",
	"恐怖と朦朧から回復し、ヒーロー気分かつ加速状態でなければHPが少し回復する。さらに、一定時間ヒーロー気分になり、加速する。",
	"アイテムを自分の足元へ移動させる。",
	"精神攻撃の球を放つ。クリーチャーに命中すると、0～1.5ターン消費する。抵抗されなければ、MPが回復する。",
...
},
{
	...
	"一定時間、攻撃してきた全てのクリーチャーを傷つけるオーラを纏う。",
	"隣りのクリーチャーに対して気をぶつけ、吹きとばす。",
	"大きな気の球を放つ。",
	"クリーチャー1体にかかった魔法を解除する。",
	"1体の幽霊を召喚する。",
...
{
	"近くの全てのクリーチャーを感知する。レベル15で透明なクリーチャーを感知する。レベル25で一定時間テレパシーを得る。レベル35で周辺の地形を感知する。全ての効果は、鏡の上でないとレベル4だけ余計に必要になる。",
	"自分のいる床の上に鏡を生成する。",
	...
	"クリーチャーをテレポートさせるビームを放つ。抵抗されると無効。",
	"破片の球を放つ。",
	"全ての鏡の周りに眠りの球を発生させる。",
	...
	"視界内のクリーチャーを減速させ、朦朧とさせ、混乱させ、恐怖させ、麻痺させる。鏡の上で使うと威力が高い。",
...
{
	"半径3以内かその部屋を暗くする。",
	"近くの全ての見えるクリーチャーを感知する。レベル5で罠/扉/階段、レベル15でアイテムを感知できるようになる。レベル45でその階全体の地形と全てのアイテムを感知する。",
	"近距離のテレポートをする。",
	"攻撃を受けた瞬間にテレポートをするようになる。失敗するとその攻撃のダメージを受ける。テレポートに失敗することもある。",
	"遠距離のテレポートをする。",
	"攻撃してすぐにテレポートする。",
	"敵1体の動きを封じる。ユニーククリーチャー相手の場合又は抵抗された場合には無効。",
	"アイテムを識別する。",
	"一定時間、浮遊能力を得る。",
	...
	"ダメージのない混乱の球を放つ。",
	"1体のクリーチャーと位置を交換する。",
	"自分のいる床の上に、クリーチャーが通ると爆発してダメージを与えるルーンを描く。",
...
{
{
	"Detects visible creatures in your vicinity and more and more. Detects traps and doors at level 5, invisible creatures at level 15, items at level 30. And magic mapping at level 20. Lights and know the whole level at level 45. Gives telepathy at level 25.",
	"Fires a beam or ball which inflicts PSI damage.",
	"Teleport short distance.",
	"Teleport long distance.",
	"Stuns, confuses or scares a creature. Or attempts to charm all creatures in sight at level 30.",
	"Fires a ball which hurts creatures with telekinesis.",
	...
	"Generate a ball centered on you which inflict creature with PSI damage. Or inflict all creatures with PSI damage at level 25.",
	...
	"Fires a ball which damages creatures and absorbs creatures' mind power. Absorbing is takes more turns which from 0 to 1.5.",
...
},
{
	...
	"Gives aura which damages all creatures which attacked you for a while.",
	"Damages an adjacent creature, and blow it away.",
	"Fires a large energy ball.",
	"Dispels all magics which is effecting a creature.",
	"Summons ghosts.",
...
{
	"Detects all creatures except mindless in your vicinity.",
	"Attacks creature with your weapons normaly, then move through counter side of the creature.",
	"Sets off a trap, then destroy that trap.",
	"Shakes dungeon structure, and results in random swaping of floors and walls.",
	"Attacks all adjacent creatures.",
	"",
	"",
	"",
	"",
...
{
	"Detects visible creatures in your vicinity and more and more. Detects invisible creatures at level 15. Gives telepathy at level 25. Magic mapping at level 35. All of effects need 4 more levels unless on a mirror.",
	"Makes a mirror under you.",
	"Fires bolt of flash light. Or fires beam of light on a mirror at level 10.",
	"Teleport short distance.",
	"Lights up nearby area and the inside of a room permanently.",
	"Teleport long distance.",
	"Gives aura of shards of mirror for a while. It cause counter attack to creatures which attacks you.",
	"Teleports all creatures on the line away unless resisted.",
	"Fires a ball of shards.",
	"Generate balls which send creatures to sleep on all mirrors in the whole level.",
	"Fires a beam of mana. If the beam hit a mirror, it breaks that mirror and reflects toward another mirror.",
	"Eliminates a creature on a mirror from current dungeon level.",
	...
	"Attempts to slow, stun, confuse, scare, freeze all creatures in sight. Gets more power on a mirror.",
	...
	"Generates a magical triangle which damages all creatures in the area. The vertices of the triangle is you and two mirrors in sight.",
...

{
	...
	"Detects visible creatures in your vicinity and more and more. Detects traps, doors and stairs at level 5, items at level 15. Lights and know the whole level at level 45.",
	"Teleport short distance.",
	...
	"Steps close to a creature and attacks at a time.",
	"Shoots 8 iron Spikes in 8 random directions.",
	"Teleport a creature to a place adjacent to you.",
	"Releases a confusion ball which doesn't inflict any damage.",
	"Swaps positions of you and a creature.",
	"Sets a glyph under you. The glyph will explode when a creature moves on it.",
