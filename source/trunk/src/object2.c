...
void object_prep(object_type *object_ptr, int k_idx, int size)
{
	...
	if (k_ptr->gen_flags & (TRG_RANDOM_CURSE1)) object_ptr->curse_flags |= get_curse(1, object_ptr);
	if (k_ptr->gen_flags & (TRG_RANDOM_CURSE2)) object_ptr->curse_flags |= get_curse(2, object_ptr);
...
void apply_magic(creature_type *owner_ptr, object_type *object_ptr, int lev, u32b mode, int specified_idx)
{
	...
	if (object_is_fixed_artifact(object_ptr))
	{
		...
		if (a_ptr->gen_flags & (TRG_RANDOM_CURSE1)) object_ptr->curse_flags |= get_curse(1, object_ptr);
		if (a_ptr->gen_flags & (TRG_RANDOM_CURSE2)) object_ptr->curse_flags |= get_curse(2, object_ptr);
	...
	if (object_is_ego(object_ptr))
	{
		...
		if (e_ptr->gen_flags & (TRG_RANDOM_CURSE1)) object_ptr->curse_flags |= get_curse(1, object_ptr);
		if (e_ptr->gen_flags & (TRG_RANDOM_CURSE2)) object_ptr->curse_flags |= get_curse(2, object_ptr);
...
static essence_type essence_info[] = 
{
	...
	{TR_KILL_EVIL, "邪悪倍倍打", 0, TRAIT_SLAY_EVIL, 60},
	{TRAIT_SLAY_GOOD, "善良倍打", 5, TRAIT_SLAY_GOOD, 100},
	{TR_KILL_GOOD, "善良倍倍打", 0, TRAIT_SLAY_GOOD, 60},
	{TRAIT_SLAY_ANIMAL, "動物倍打", 5, TRAIT_SLAY_ANIMAL, 20},
	{TR_KILL_ANIMAL, "動物倍倍打", 5, TRAIT_SLAY_ANIMAL, 60},
	{TRAIT_SLAY_UNDEAD, "不死倍打", 5, TRAIT_SLAY_UNDEAD, 20},
	{TR_KILL_UNDEAD, "不死倍倍打", 5, TRAIT_SLAY_UNDEAD, 60},
	{TRAIT_SLAY_DEMON, "悪魔倍打", 5, TRAIT_SLAY_DEMON, 20},
	{TR_KILL_DEMON, "悪魔倍倍打", 5, TRAIT_SLAY_DEMON, 60},
	{TRAIT_SLAY_ORC, "オーク倍打", 5, TRAIT_SLAY_ORC, 15},
	{TR_KILL_ORC, "オーク倍倍打", 5, TRAIT_SLAY_ORC, 60},
	{TRAIT_SLAY_TROLL, "トロル倍打", 5, TRAIT_SLAY_TROLL, 15},
	{TR_KILL_TROLL, "トロル倍倍打", 5, TRAIT_SLAY_TROLL, 60},
	{TRAIT_SLAY_GIANT, "巨人倍打", 5, TRAIT_SLAY_GIANT, 20},
	{TR_KILL_GIANT, "巨人倍倍打", 5, TRAIT_SLAY_GIANT, 60},       
	{TRAIT_SLAY_DRAGON, "竜倍打", 5, TRAIT_SLAY_DRAGON, 20},
	{TR_KILL_DRAGON, "竜倍倍打", 5, TRAIT_SLAY_DRAGON, 60},
	{TRAIT_SLAY_HUMAN, "人間倍打", 5, TRAIT_SLAY_HUMAN, 20},
	{TR_KILL_HUMAN, "人間倍倍打", 5, TRAIT_SLAY_HUMAN, 60},
