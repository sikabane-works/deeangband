...
/*
 * ‘SŠp•¶š‘Î‰B
 * ‘®«‚É‘SŠp•¶š‚Ì‚PƒoƒCƒg–ÚA‚QƒoƒCƒg–Ú‚à‹L‰¯B
 * By FIRST
 */
#endif
/*
...
void Term_queue_chars(int x, int y, int n, byte a, cptr s)
{
	...
	if(n == 0 || *s == 0) return;
	/*
	 * ‘SŠp•¶š‚Ì‰E”¼•ª‚©‚ç•¶š‚ğ•\¦‚·‚éê‡A
	 * d‚È‚Á‚½•¶š‚Ì¶•”•ª‚ğÁ‹B
	 * •\¦ŠJnˆÊ’u‚ª¶’[‚Å‚È‚¢‚Æ‰¼’èB
	 */
...
#ifdef JP
	/*
	 * ‘SŠp•¶š‚Ì¶”¼•ª‚Å•\¦‚ğI—¹‚·‚éê‡A
	 * d‚È‚Á‚½•¶š‚Ì‰E•”•ª‚ğÁ‹B
	 * (ğŒ’Ç‰ÁFƒ^ƒCƒ‹‚Ì1•¶š–Ú‚Å‚È‚¢–‚ğŠm‚©‚ß‚é‚æ‚¤‚ÉB)
	 */
	{
