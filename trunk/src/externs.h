...
extern void calc_bonuses(creature_type *cr_ptr);
...
extern bool get_subrace(int n);
extern void set_subrace(int n, bool b);
extern cptr get_intelligent_race_name(void);
