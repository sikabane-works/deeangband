...
void apply_magic(object_type *o_ptr, int lev, u32b mode)
{
	...
	if (p_ptr->seikaku == SEIKAKU_MUNCHKIN) lev += randint0(p_ptr->lev/2+10);
	...
	if ((p_ptr->seikaku != SEIKAKU_MUNCHKIN) && (f2 > d_info[dungeon_type].obj_great))
