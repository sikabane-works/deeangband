...
●Macintosh
  ...
  いずれ対応を目指したいですが当面はサポート外です。申し訳ありません。
...
●タイルグラフィック、二倍幅タイル表示、大画面表示
  ...
  は16x16タイルは付属していないので、Linuxの場合はdeeang_graf.tar.gzを別
...
●プレイ記録
  ...
  UNIXでは ~/.angband/Deeangband/ 、それ以外のOSでは変愚蛮怒の中の lib/user/ の
...
以上、Mr.hoge氏の変愚蛮怒 readme.txtを拝借、修正。
