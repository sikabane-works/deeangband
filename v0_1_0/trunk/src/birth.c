...
"森深くにあるアングウィルはその名や建築の様式において、恐らくは本来上古のエルフが作り上げた都市であり、実際その統領である指輪の乙女コルマンウェンはテレリ族の王族に近しい齢数千歳のエルフです。しかし彼女を筆頭とするアングウィルの名士達は西方の自由の民を称する者達を明らかに軽蔑しています。一方、彼等は東方の列強、特にウルクやアヴァリに対しては非常に友好的で、彼等くらやみの国へ極めて良質の金属を売ることで栄え、西方の自由の民全ての富をかき集めてもまだ及ばない繁栄を得ています。",
