...
#define AUTHORITY_LIGHT4  19
#define AUTHORITY_DARK1   20
#define AUTHORITY_DARK2   21
#define AUTHORITY_DARK3   22
#define AUTHORITY_DARK4   23
#define AUTHORITY_LAW1    24
#define AUTHORITY_LAW2    25
#define AUTHORITY_LAW3    26
#define AUTHORITY_LAW4    27
#define AUTHORITY_CHAOS1  28
#define AUTHORITY_CHAOS2  29
#define AUTHORITY_CHAOS3  30
#define AUTHORITY_CHAOS4  31
...
#define music_singing(C, X) ((C->cls_idx == CLASS_BARD) && (p_ptr->magic_num1[0] == (X)))
#define music_singing_any(C) ((C->cls_idx == CLASS_BARD) && p_ptr->magic_num1[0])
