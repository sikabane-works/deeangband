...
#ifdef JP
					take_hit(p_ptr, DAMAGE_NOESCAPE, damroll(2, 2), "日の光", -1);
#else
...
#ifdef JP
					take_hit(p_ptr, DAMAGE_NOESCAPE, 50, "日光", -1);
#else
...
#ifdef JP
				take_hit(p_ptr, DAMAGE_USELIFE, 20 + randint1(30), "地獄の劫火の呪文を唱えた疲労", -1);
#else
...
#ifdef JP
				take_hit(p_ptr, DAMAGE_USELIFE, 20 + randint1(30), "血の呪い", -1);
#else
...
#ifdef JP
			take_hit(p_ptr, DAMAGE_NOESCAPE, 100 + randint1(100), "慶雲鬼忍剣を使った衝撃", -1);
#else
