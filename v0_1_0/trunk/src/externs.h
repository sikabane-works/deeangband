...
extern intelligent_race mimic_info[];
...
extern bool py_attack(creature_type *cr_ptr, int y, int x, int mode);
...
extern bool set_monster_csleep(creature_type *cr_ptr, int v);
extern bool set_monster_fast(creature_type *cr_ptr, int v);
extern bool set_monster_slow(creature_type *cr_ptr, int v);
extern bool set_monster_stunned(creature_type *cr_ptr, int v);
extern bool set_monster_confused(creature_type *cr_ptr, int v);
extern bool set_monster_monfear(creature_type *cr_ptr, int v);
extern bool set_monster_invulner(creature_type *cr_ptr, int v, bool energy_need);
...
extern int take_hit_old(creature_type *atk_ptr, creature_type *tar_ptr, int damage_type, int damage, cptr hit_from, cptr note, int monspell);
...
extern void get_exp_from_mon(int dam, creature_type *m_ptr);
