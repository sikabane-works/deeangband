...
extern bool summon_named_creature (int who, int oy, int ox, int species_idx, u32b mode);
...
extern void have_nightmare(int species_idx);
...
extern cptr extract_note_dies(species_type *r_ptr);
