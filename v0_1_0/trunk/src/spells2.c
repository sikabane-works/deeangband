...
sprintf(Dummy, "現在の体力ランク : %d/100", percent);
	...
	{
#ifdef JP
		sprintf(Dummy, "あなたは〈善〉の敵である。(対邪スレイx%d.%02d)", percent / 100, percent % 100);
#else
	...
	{
#ifdef JP
		sprintf(Dummy, "あなたは〈悪〉の敵である。(対善スレイx%d.%02d)", percent / 100, percent % 100);
#else
	...
	{
#ifdef JP
		sprintf(Dummy, "あなたは〈秩序〉の敵である。(対混沌スレイx%d.%02d)", percent / 100, percent % 100);
#else
	...
	{
#ifdef JP
		sprintf(Dummy, "あなたは〈混沌〉の敵である。(対秩序スレイx%d.%02d)", percent / 100, percent % 100);
#else
	...
	{
#ifdef JP
		sprintf(Dummy, "あなたは〈天秤〉の敵である。(スレイx%d.%02d)", percent / 100, percent % 100);
#else
