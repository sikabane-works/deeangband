...
{
#ifdef JP
	if (p_ptr->align > 80 && p_ptr->ethics > 80) return "秩序にして善";
	else if (p_ptr->align > 80 && p_ptr->ethics < -80) return "混沌にして善";
	else if (p_ptr->align < -80 && p_ptr->ethics > 80) return "秩序にして悪";
	else if (p_ptr->align < -80 && p_ptr->ethics < -80) return "混沌にして悪";
	else if (p_ptr->align > 80) return "中立にして善";
	else if (p_ptr->align < -80) return "中立にして悪";
	else if (p_ptr->ethics > 80) return "秩序にして中立";
	else if (p_ptr->ethics < -80) return "混沌にして中立";
	else return "真なる中立";
#else
