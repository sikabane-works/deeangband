...
static void cast_shuffle(creature_type *cr_ptr)
{
	...
	else if (die < 14)
	{
		...
		summon_specific(0, cr_ptr->fy, cr_ptr->fx, dun_level, SUMMON_DEMON, (PM_ALLOW_GROUP | PM_ALLOW_UNIQUE | PM_NO_PET));
	}
	else if (die < 18)
	{
		int count = 0;
	...
	case 0:
    ...
    
		{
			...
			if (cast)
			{
				...
				fire_bolt_or_beam(cr_ptr, beam_chance(cr_ptr) - 10, GF_MISSILE, dir, damroll(dice, sides));
			}
		}
		break;
	...
	case 4:
    ...
    
		{
			...
			if (cast)
			{
				...
				fire_ball(cr_ptr, GF_MISSILE, dir, damroll(dice, sides) + base, rad);
	...
	case 5:
    ...
    
		{
			...
			if (cast)
			{
				...
				fire_bolt_or_beam(cr_ptr, beam_chance(cr_ptr), GF_FIRE, dir, damroll(dice, sides));
			}
		}
		break;
	...
	case 9:
    ...
    
		{
			...
			if (cast)
			{
				...
				fire_bolt_or_beam(cr_ptr, beam_chance(cr_ptr), GF_CHAOS, dir, damroll(dice, sides));
			}
		}
		break;
	...
	case 1:
    ...
    
		{
			...
			if (cast)
			{
				...
				fire_ball(cr_ptr, GF_HELL_FIRE, dir, damroll(dice, sides), rad);
	...
	case 8:
    ...
    
		{
			...
			if (cast)
			{
				...
				fire_ball(cr_ptr, GF_OLD_DRAIN, dir, damroll(dice, dice) + base, rad);
			}
		}
		break;
	...
	case 9:
    ...
    
		{
			...
			if (cast)
			{
				...
				fire_bolt_or_beam(cr_ptr, beam_chance(cr_ptr), GF_NETHER, dir, damroll(dice, sides));
			}
		}
		break;
	...
	case 18:
    ...
    
		{
			...
			if (cast)
			{
				...
				fire_bolt_or_beam(cr_ptr, beam_chance(cr_ptr), GF_DARK, dir, damroll(dice, sides));
			}
		}
		break;
	...
	case 22:
    ...
    
		{
			if (cast)
			{
				...
				/* Gain the mutation */
				if (gain_random_mutation(cr_ptr, mutation, TRUE))
				{
#ifdef JP
	...
	case 7:
    ...
    
		{
			...
			if (cast)
			{
				...
				fire_ball(cr_ptr, GF_HELL_FIRE, dir, damroll(dice, sides) + base, rad);
			}
		}
		break;
	...
	case 11:
    ...
    
		{
			...
			if (cast)
			{
				...
				fire_bolt_or_beam(cr_ptr, beam_chance(cr_ptr), GF_PLASMA, dir, damroll(dice, sides));
			}
		}
		break;
	...
	case 2:
...

		{
			...
			if (cast)
			{
				...
				fire_bolt(cr_ptr, GF_SOUND, dir, damroll(dice, sides));
			}
		}
		break;
	...
	case 30:
    ...
    
		{
			...
			if (cast)
			{
				...
				fire_ball(cr_ptr, GF_SOUND, dir, damroll(dice, sides), rad);
			}
		}
		break;
...
static cptr do_hissatsu_spell(creature_type *cr_ptr, int spell, int mode)
{
	...
	case 3:
		...
		if (cast)
		{
			...
			if (cave[y][x].m_idx)
				weapon_attack(cr_ptr, y, x, HISSATSU_FIRE);
			else
			{
#ifdef JP
	...
	case 5:
		...
		if (cast)
		{
			...
			if (cave[y][x].m_idx)
				weapon_attack(cr_ptr, y, x, HISSATSU_MINEUCHI);
			else
			{
#ifdef JP
				msg_print("その方向にはモンスターはいません。");
	...
	case 8:
		...
		if (cast)
		{
			...
			if (cave[y][x].m_idx)
				weapon_attack(cr_ptr, y, x, HISSATSU_POISON);
			else
			{
#ifdef JP
				msg_print("その方向にはモンスターはいません。");
	...
	case 9:
		...
		if (cast)
		{
			...
			if (cave[y][x].m_idx)
				weapon_attack(cr_ptr, y, x, HISSATSU_ZANMA);
			else
			{
#ifdef JP
				msg_print("その方向にはモンスターはいません。");
	...
	case 13:
		...
		if (cast)
		{
			...
			if (cave[y][x].m_idx)
				weapon_attack(cr_ptr, y, x, HISSATSU_COLD);
			else
			{
#ifdef JP
				msg_print("その方向にはモンスターはいません。");
	...
	case 14:
		...
		if (cast)
		{
			...
			if (cave[y][x].m_idx)
				weapon_attack(cr_ptr, y, x, HISSATSU_KYUSHO);
			else
			{
#ifdef JP
				msg_print("その方向にはモンスターはいません。");
	...
	case 15:
		...
		if (cast)
		{
			...
			if (cave[y][x].m_idx)
				weapon_attack(cr_ptr, y, x, HISSATSU_MAJIN);
			else
			{
#ifdef JP
				msg_print("その方向にはモンスターはいません。");
	...
	case 16:
		...
		if (cast)
		{
			...
			if (cave[y][x].m_idx)
				weapon_attack(cr_ptr, y, x, HISSATSU_SUTEMI);
			else
			{
#ifdef JP
				msg_print("その方向にはモンスターはいません。");
	...
	case 17:
		...
		if (cast)
		{
			...
			if (cave[y][x].m_idx)
				weapon_attack(cr_ptr, y, x, HISSATSU_ELEC);
			else
			{
#ifdef JP
				msg_print("その方向にはモンスターはいません。");
		...
		if (cast)
		{
			...
			for (dir = 0; dir < 8; dir++)
			{
				...
				if (c_ptr->m_idx && (m_ptr->ml || cave_have_flag_bold(y, x, FF_PROJECT)))
				{
					...
					else weapon_attack(cr_ptr, y, x, HISSATSU_SEKIRYUKA);
				}
			}
		}
		break;
	...
	case 20:
		...
		if (cast)
		{
			...
			if (cave[y][x].m_idx)
				weapon_attack(cr_ptr, y, x, HISSATSU_QUAKE);
			else
				earthquake(cr_ptr, cr_ptr->fy, cr_ptr->fx, 10);
		}
		break;
	...
	case 21:
		...
		if (cast)
		{
			...
			for (i = 0; i < 2; i++)
			{
				...
				if (!get_equipped_slot_ptr(cr_ptr, ITEM_SLOT_HAND, i+1)) break;
				o_ptr = get_equipped_slot_ptr(cr_ptr, ITEM_SLOT_HAND, i+1);
	...
	case 23:
		...
		if (cast)
		{
			...
			for (i = 0; i < 3; i++)
			{
				...
				if (c_ptr->m_idx)
					weapon_attack(cr_ptr, y, x, HISSATSU_3DAN);
				else
				{
#ifdef JP
					msg_print("その方向にはモンスターはいません。");
	...
	case 24:
		...
		if (cast)
		{
			...
			if (cave[y][x].m_idx)
				weapon_attack(cr_ptr, y, x, HISSATSU_DRAIN);
			else
			{
#ifdef JP
					msg_print("その方向にはモンスターはいません。");
	...
	case 30:
		...
		if (cast)
		{
			...
			if (cave[y][x].m_idx)
				weapon_attack(cr_ptr, y, x, HISSATSU_UNDEAD);
			else
			{
#ifdef JP
				msg_print("その方向にはモンスターはいません。");
